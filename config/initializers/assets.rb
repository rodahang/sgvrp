...
Rails.application.config.assets.precompile += %w( vrpsg.scss )
Rails.application.config.assets.precompile += %w( gradient.scss )
Rails.application.config.assets.precompile += %w( inputvrp.scss )
Rails.application.config.assets.precompile += %w( dropbox.scss )
Rails.application.config.assets.precompile += %w( vrp_main.scss )
